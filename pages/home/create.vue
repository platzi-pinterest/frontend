<template>
  ...
  >
    <v-row>
      <v-col cols="4" class="mx-auto mr-0">
        <v-select
          v-model="form.board"
          :items="form.board"
          filled
      ...
      <v-col cols="2" class="mx-0 my-auto">
        <v-btn
          depressed
          large
          color="error"
    ...
    <v-list-item three-line>
      ...
      <v-list-item-content>
        ...
        <v-list-item-subtitle class="mb-10">
          <v-text-field
            v-model="form.about"
            label="Tell everyone waht your Pin is about"
          />
